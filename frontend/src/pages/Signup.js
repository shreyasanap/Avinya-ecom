...
import loginIcon from "../assets/pfp.jpg";
...
const Signup = () => {
  ...
  // Summary API me sab summaries hai jo post kiya tha from rapidapi
  const handleSubmit = async (e) => {
    e.preventDefault();

    if (data.password === data.confirmPassword) {
      // console.log("SummaryApi.signUp.method",SummaryApi.signUp.url)
